...
class EditAccountPage extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final editAccountPageState = ref.watch(editAccountPageProvider);
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          if (editAccountPageState.isLoading)
            WidgetUtils.createCircularProgress(),
          myAccount == null
              ? Container(
                        ...
                        Padding(
                          ...
                          child: SizedBox(
                            ...
                            child: TextField(
                              ...
                              decoration:
                                  const InputDecoration(hintText: "ユーザーID"),
                            ),
                          ),
                        ),
                        SizedBox(
